...
import { assignUniqueHeadingIds } from './toc';
...
export function processMarkdownContent<T>(
  ...
  try {
    ...
    // Pre-assign unique heading ids so the rendered Heading components match
    // the ids generated by extractToc on a fresh parse of the same markdown.
